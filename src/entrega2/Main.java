...
public class Main {
	...
	public static void generateTest(String filename) throws IOException {
		...
		ArrayList<BigInteger> numbers = new ArrayList<>(Arrays.asList(
				  new BigInteger("776159"), new BigInteger("776161"), 
				  new BigInteger("98982599"), new BigInteger("98982601"),
				  new BigInteger("9984605927"), new BigInteger("9984605929"), 
				  new BigInteger("999498062999"), new BigInteger("999498063001"), 
				  new BigInteger("99996460031327"), new BigInteger("99996460031329"), 
