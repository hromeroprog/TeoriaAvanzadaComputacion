...
public class PolyTests 
{
	...
	/**
	 * Test method for {@link Poly#Poly(BigInteger, int)}.
	 */
	@Test
	...
	{
		Poly p = new Poly(BigInteger.ONE, 10);
		Poly q = p.times(p).multiplyCoeffBy(new BigInteger("5"));
		Poly r = new Poly(BigInteger.ONE, 5);
		Poly s = r.plus(p).times(q).plus(p.multiplyCoeffBy(new BigInteger("3")));
		
		System.out.println("testEqualsPoly: s = " + s);
		
		Poly t = s.modCoeffBy(new BigInteger("3"));
	...
	/**
	 * Test method for {@link Poly#multiplyCoeffBy(BigInteger)}.
	 */
	@Test
	public void testTimesBigInteger() 
	{
		...
		Poly q = p.multiplyCoeffBy(new BigInteger("10"));
		...
		Poly r = new Poly(BigInteger.ONE, 20);
		Poly s = r.multiplyCoeffBy(new BigInteger("9"));
	...
	/**
	 * Test method for {@link Poly#modCoeffBy(BigInteger)}.
	 */
	@Test
